...
export const TEXTOS_PREDETERMINADOS = {
  ...
  footer_catalogo: 'Catálogo completo',
  ...
  plantillas_descripcion: 'Las nuevas colecciones aparecerán aquí cuando sean publicadas desde el dashboard.',
  ...
  fisicos_descripcion: 'Los productos armados y personalizados aparecerán aquí cuando se publiquen desde el dashboard.',
  ...
  producto_aviso_whatsapp: 'Agregá este producto a tu selección. La disponibilidad, el precio final y la entrega se confirman personalmente por WhatsApp.',
  carrito_etiqueta: 'Tu pedido',
  carrito_titulo: 'Mi selección',
  carrito_vacio: 'Todavía no agregaste productos.',
  carrito_explorar_catalogo: 'Explorar catálogo',
  ...
  mensaje_whatsapp_inicio: '¡Hola! Quisiera consultar por los siguientes productos de Papelería de Sol:',
  mensaje_whatsapp_total_productos: 'Total de productos',
  mensaje_whatsapp_total: 'Total',
  mensaje_whatsapp_cierre: '¿Podrían confirmarme disponibilidad y precio final?',
  ...
  ayuda_paso_1_titulo: '1. Explorá el catálogo',
  ...
  ayuda_paso_3_descripcion: 'Al continuar, se abre WhatsApp con el detalle de los productos elegidos para consultar disponibilidad.',
  ayuda_consultas_titulo: '¿Tenés una idea especial?',
  ayuda_consultas_descripcion: 'Escribinos por WhatsApp. Allí coordinamos productos personalizados, disponibilidad, entrega y pago.',
